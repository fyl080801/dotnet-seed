...
namespace SeedModules.Admin.Controllers
{
    public class HomeController : Controller
    {
        ...
        [RouteRequires("rcss!SeedModules.AngularUI/css/bootstrap-theme.min.css", "rcss!SeedModules.Admin/less/seed-admin.css", "SeedModules.Admin/modules/login/module")]
        ...
        [Authorize]
        [GenerateAntiforgeryTokenCookie]
        [RouteRequires("rcss!SeedModules.AngularUI/css/bootstrap-theme.min.css", "rcss!SeedModules.Admin/less/seed-admin.css", "SeedModules.Admin/modules/admin/module")]
