    ...
    module.directive('sidebar', [
        function () {
            return {
                restrict: 'AE',
                replace: true,
                template: '<div class="sidebar"><div class="sidebar-top"><a href="{{homeHref}}"><i class="fas fa-home fa-fw"></i> <span>{{homeTitle}}</span></a></div><ul sidebar-nav nav-data="navData"></ul></div>',
                scope: {
                    sidebar: '=',
                    navData: '=',
                    homeHref: '@',
