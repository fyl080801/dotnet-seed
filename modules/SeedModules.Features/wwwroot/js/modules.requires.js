define('SeedModules.Features/modules/controllers/features', [
    'require',
    'exports',
    ...
    var FeaturesController = function () {
        ...
        FeaturesController.prototype.setEnable = function (feature, enabled) {
            ...
            this.requestService.url('/api/features/' + feature.descriptor.id).patch({ enabled: feature.enabled }).result.then(function (result) {
                self.load();
            });
        };
        FeaturesController.prototype.load = function () {
            var self = this;
            this.$scope.requesting = this.requestService.url('/api/features?keyword=' + this.$scope.keyword).options({ showLoading: false }).get();
...
define('SeedModules.Features/modules/requires', [
    'require',
    'exports',
